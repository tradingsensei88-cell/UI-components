...
function TouchStart(e) {
  if (e.touches.length > 0) {
    // e.preventDefault(); // Removed to allow clicks and scrolling on mobile
...
function createBallpit(e, t = {}) {
  ...
  e.style.touchAction = 'pan-y'; // Changed from 'none' to 'pan-y' to allow vertical scrolling
  e.style.userSelect = 'none';
  e.style.webkitUserSelect = 'none';
  e.style.pointerEvents = 'none'; // Ensure the canvas itself doesn't block clicks
